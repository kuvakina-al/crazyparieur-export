        ...
        <main class="main-content">
            <div class="container">
                <section class="section">
                    <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 900; font-size: 38px; line-height: 120%; letter-spacing: 0%; text-align: center; color: #00ff41; margin-bottom: 15px;">Dunk sur les Cotes - Votre Guide pour Parier sur le Basketball</h1>
                    <p style="font-family: 'Montserrat', sans-serif; font-weight: 300; font-size: 20px; line-height: 120%; letter-spacing: 0%; text-align: center; color: #FFFFFF; margin-bottom: 20px;">Crazy Parieur vous propose un accompagnement complet: astuces, stratégies et comparatifs pour réussir vos paris de basketball en ligne.</p>
